            ...
            <div class="container">
                <div class="row">
                    <div class="home-info padd-15">
                        <h3 class="hello">Hello, my name is <span class="name">Muhamad Gildan NR</span></h3>
                        <h3 class="my-professioin">I'm a <span class="typing">Web Designer</span></h3>
                        <p>I am a self-taught web developer with a passion for creating beautiful and functional websites. I have a strong passion for learning and I am always looking to improve my skills...</p>
                        <a href="#contact" class="btn hire-me">More About Me</a>
                    </div>
                    <div class="home-img padd-15">
                        <img src="/css/image/candit.jpeg" alt="">
                    </div>
                </div>
            </div>
            </section>
                        ...
                        <div class="about-content padd-15">
                            <div class="row">
                                <div class="about-text padd-15">
                                    <h3>I'm Muhamad Gildan NR and <span>Front End Development</span></h3>
                                    <p>The front end is what users see on the appearance of a website.
                                        I am a self-taught web developer with a passion for creating beautiful and functional websites.</p>
                                </div>
                            </div>
                            <div class="row">
                               <div class="personal-info padd-15">
                                <div class="row">
                                    <div class="info-item padd-15">
                                        <p>Birthday : <span>25 Sep 2006</span></p>
                                    </div>
                                    <div class="info-item padd-15">
                                        <p>Age : <span>15</span></p>
                                    </div>
                                    <div class="info-item padd-15">
                                        <p>Website : <span>https://mgildannr.netlify.app/</span></p>
                                    </div>
                                    <div class="info-item padd-15">
                                        <p>Email : <span>gildannr06@gmail.com</span></p>
                                    </div>
                                    <div class="info-item padd-15">
                                        <p>Phone : <span>+62 838-7314-8767</span></p>
                                    </div>
                                    <div class="info-item padd-15">
                                        <p>City : <span>Bogor</span></p>
                                    </div>
                                </div>
                                <div class="row">
                                        ...
                                        <div class="timeline-box padd-15">
                                            <div class="timeline shadow-dark">
                                                ...
                                                <div class="timeline-item">
                                                    ...
                                                    <h4 class="timeline-title"> Intruduce My Self</h4>
                                                    <p class="timeline-text">My name is Muhamad Gildan NR, you can call me Gildan. I was born on September, 25 2006.
                    ...
                    <div class="row">
                        ...
                        <div class="service-item padd-15">
                            <div class="service-item-inner">
                                ...
                                <h4>Web Design</h4>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure molestiae reprehenderit ipsum.
                                </p>
                            </div>
                        </div>
                        <!-- ===== Service Item End ===== -->
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="portfolio-item padd-15">
                            <div class="portfolio-item-inner shadow-dark">
                                <div class="portfolio-img">
                                    <img src="/css/image/portfolio (1).png" alt="">
                                </div>
                            </div>
                        </div>
                        <!-- ===== portfolio item end ===== -->
                        ...
                        <div class="portfolio-item padd-15">
                            <div class="portfolio-item-inner shadow-dark">
                                <div class="portfolio-img">
                                    <img src="/css/image/portfolio (2).png" alt="">
                                </div>
                            </div>
                        </div>
                        <!-- ===== portfolio item end ===== -->
                        ...
                        <div class="portfolio-item padd-15">
                            <div class="portfolio-item-inner shadow-dark">
                                <div class="portfolio-img">
                                    <img src="/css/image/portfolio (3).png" alt="">
                                </div>
                            </div>
                        </div>
                        <!-- ===== portfolio item end ===== -->
                        ...
                        <div class="portfolio-item padd-15">
                            <div class="portfolio-item-inner shadow-dark">
                                <div class="portfolio-img">
                                    <img src="/css/image/portfolio (4).png" alt="">
                                </div>
                            </div>
                        </div>
                        <!-- ===== portfolio item end ===== -->
                        ...
                        <div class="portfolio-item padd-15">
                            <div class="portfolio-item-inner shadow-dark">
                                <div class="portfolio-img">
                                    <img src="/css/image/portfolio (5).png" alt="">
                                </div>
                            </div>
                        </div>
                        <!-- ===== portfolio item end ===== -->
                        ...
                        <div class="portfolio-item padd-15">
                            <div class="portfolio-item-inner shadow-dark">
                                <div class="portfolio-img">
                                    <img src="/css/image/portfolio (6).png" alt="">
                                </div>
                            </div>
                        </div>
                        <!-- ===== portfolio item end ===== -->
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="contact-info-item padd-15">
                            ...
                            <h4>Website</h4>
                            <p>https://mgildannr.netlify.app</p>
                        </div>
                        <!-- ===== Contact Info item End ===== -->
                    </div>
...
<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
    (function(){
        emailjs.init('0hOpa-MRYGkQZktiu');
    })  
</script>
